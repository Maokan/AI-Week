  ...
  return (
    <div className="landing-container">
      ...
      <main className="landing-hero">
        <div className="landing-badge">Nouveau — Plateforme Intelligente 🚀</div>
        <h1 className="landing-title">Réinventez la gestion de votre scolarité</h1>
        <p className="landing-subtitle">
          Une plateforme centralisée pour suivre vos notes, gérer vos projets et communiquer avec vos encadrants, propulsée par un système IA intégré.
        </p>
